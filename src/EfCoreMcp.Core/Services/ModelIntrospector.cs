...
public sealed class ModelIntrospector : IModelIntrospector
{
    private readonly IDbContextProvider _contextProvider;
    private readonly object _cacheLock = new();
    private (string AssemblyIdentity, ModelDescriptor Descriptor)? _modelCache;

    public ModelIntrospector(IDbContextProvider contextProvider)
    {
    ...
    {
        var ctx = _contextProvider.GetContext();
